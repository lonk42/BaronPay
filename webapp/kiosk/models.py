...
class Product(models.Model):
    ...
    def __str__(self):
        return ("id: %s, price: %s, enabled: %s, thumbnail_file: %s, notes: %s, discount_text; %s") % (self.id, self.price, self.enabled, self.thumbnail_file, self.notes, self.discount_text)
